...
class CuentaBancaria
{
    private:
        int saldo;
    public:
        CuentaBancaria(float saldoInicial) : saldo(saldoInicial) {}  //constructor
...
{
    public:
        virtual ~OperacionBancaria() = default;
        virtual void realizarOperacion(float cantidad, CuentaBancaria& cuenta, CuentaBancaria* cuentaDestino = nullptr) const = 0;
};
class Deposito : public OperacionBancaria 
{
    void realizarOperacion(float cantidad, CuentaBancaria& cuenta, CuentaBancaria* cuentaDestino = nullptr) const override 
    {
        if (cantidad > 0) 
        {
...
int main()
{
    ...
    int opcion;
    float cantidad;
    const OperacionBancaria* operacion;
